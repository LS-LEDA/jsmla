...
function renderDefaultDashboard() {
  ...
  let widgetsTemplate = [
...

    {
      ...
      title: "C1 - Law",
      tooltip:
          "Transmito información relevante..",
      srcJS: "https://cdn.jsdelivr.net/npm/chart.js@2.8.0",
      srcCSS: "",
      mode: WIDGET_CODE_SNIPPET,
      snippet:
    ...
    },
    {
      ...
      title: "C2 - Law",
      tooltip:
          "Las presentaciones están estructuradas, cumpliendo con los requisitos exigidos, si los hubiera.",
      srcJS: "https://cdn.jsdelivr.net/npm/chart.js@2.8.0",
      srcCSS: "",
      mode: WIDGET_CODE_SNIPPET,
      snippet:
    ...
    },
    {
      ...
      title: "C3 - Law",
      tooltip:
          "En mis presentaciones utilizo medios de apoyo.",
      srcJS: "https://cdn.jsdelivr.net/npm/chart.js@2.8.0",
      srcCSS: "",
      mode: WIDGET_CODE_SNIPPET,
      snippet:
