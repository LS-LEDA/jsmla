...
function schema(item) {
  ...
  if (item["Marca temporal"]) {
    ...
    if ("/" === item["Marca temporal"].substr(1, 1)) {
      item["Marca temporal"] = "0" + item["Marca temporal"];
    }
    if ("/" === item["Marca temporal"].substr(4, 1)) {
      item["Marca temporal"] =
        item["Marca temporal"].substr(0, 3) +
        "0" +
        item["Marca temporal"].substr(3, 15);
    }
    fields = {
      fullDate: item["Marca temporal"],
      yearMonthDay:
        item["Marca temporal"].substr(6, 4) +
        "" +
        item["Marca temporal"].substr(0, 2) +
        "" +
        item["Marca temporal"].substr(3, 2),
      yearMonthDayHourMinute:
        ...
        item["Marca temporal"].substr(3, 2) +
        "" +
        item["Marca temporal"].substr(11, 2) +
        "" +
